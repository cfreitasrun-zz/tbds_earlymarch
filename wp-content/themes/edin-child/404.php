...
get_header(); ?>
	...
	<div class="hero <?php echo edin_additional_class(); ?>">
		<div class="hero-wrapper"><h1 class="page-title"><?php _e( 'Whoops, Took a Wrong Turn...', 'edin' ); ?></h1></div>
	</div><!-- .hero -->
		...
		<div id="primary" class="content-area">
			<main id="main" class="site-main" role="main">
				...
				<div class="page-content">
					<p><?php _e( 'Sorry, this page no longer exists, never existed or has
					              been moved.  We feel like complete jerks for totally
					              misleading you... Maybe try a search?', 'edin' ); ?></p>
